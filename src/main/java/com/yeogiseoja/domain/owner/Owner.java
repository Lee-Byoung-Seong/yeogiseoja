...
import com.yeogiseoja.domain.AbstractEntity;
import com.yeogiseoja.domain.accommodation.Accommodation;
import lombok.*;
...
public class Owner extends AbstractEntity {
    ...
    public Owner confirmAuthToken(String authToken) {
