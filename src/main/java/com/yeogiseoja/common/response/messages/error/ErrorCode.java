package com.yeogiseoja.common.response.messages.error;
...
public enum ErrorCode {
    ...
    IS_AUTH_NOT_YET_USER("미인증 유저가 아닙니다, 관리자에게 문의해 주세요"),
    NOT_EMAIL_FORMAT("이메일 형식을 확인해주세요"),
    NOT_EXIST_USER("사용자가 존재하지 않습니다"),
    BUSINESS_LICENSE_NUMBER_NOT_FORMAT("사업자 번호 형식을  확인해주세요"),
    BUSINESS_LICENSE_NUMBER_INCLUDE_STRING("사업자 등록번호에 문자가 존재합니다"),
